...
grid_search_cv = GridSearchCV(estimator=pipe, param_grid=param_grid, scoring="roc_auc_ovo_weighted", verbose=2)
...
results_df.to_csv('results/catboost_classification_cv_results.csv', index=False)
...
generate_confusion_matrix(FantAIno_KNN_y_test, preds, "catboost_classifier_grid_CM")