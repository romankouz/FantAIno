...
FantAIno_KNN_X_train = FantAIno_KNN_X_train[FantAIno_KNN_features]
FantAIno_KNN_X_test = FantAIno_KNN_X_test[FantAIno_KNN_features]
...
plt.savefig("results/knn_classification_CM.png")